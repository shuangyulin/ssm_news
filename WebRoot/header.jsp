        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>NewsClass/frontlist">新闻分类</a></li>
                <li><a href="<%=basePath %>News/frontlist">新闻信息</a></li>
                <li><a href="<%=basePath %>UserInfo/frontlist">用户信息</a></li>
                <li><a href="<%=basePath %>NewsTag/frontlist">新闻标记</a></li>
                <li><a href="<%=basePath %>NewsComment/frontlist">新闻评论</a></li>
                <li><a href="<%=basePath %>NewsCollection/frontlist">新闻收藏</a></li>
                <li><a href="<%=basePath %>Zambia/frontlist">新闻赞</a></li>
