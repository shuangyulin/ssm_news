...
<div id="news_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="newsQueryForm" method="post">
			新闻类别：<input class="textbox" type="text" id="newsClassObj_newsClassId_query" name="newsClassObj.newsClassId" style="width: auto"/>
			新闻标题：<input type="text" class="textbox" id="newsTitle" name="newsTitle" style="width:110px" />
			新闻来源：<input type="text" class="textbox" id="comFrom" name="comFrom" style="width:110px" />
